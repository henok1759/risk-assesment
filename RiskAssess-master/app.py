...
try:
    ...
    print("Failed to find 'model.pkl'. Please check the file path.")
except Exception as e:
    print(f"An error occurred while loading 'model.pkl': {e}")

# Load the second model in a similar way
try:
    with open('model1.pkl', 'rb') as file:
        model1 = pickle.load(file)
except FileNotFoundError:
    print("Failed to find 'model1.pkl'. Please check the file path.")
except Exception as e:
    print(f"An error occurred while loading 'model1.pkl': {e}")
...
class User(db.Model, UserMixin):
    __tablename__ = 'user'  # Explicitly setting the table name (optional)
